...
import Vivek from '../assets/vivek2101240me.JPG';
          ...
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300">
                A 3rd year student of Mechatronics, Robotics enthusiast and MERN stack web developer
              </p>
              <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                ...
                <a
                  href="https://www.linkedin.com/in/vivek-kumar-470b98226/"
                  className="text-sm font-semibold leading-6 text-white"
                >
                  <FontAwesomeIcon icon={faLinkedinIn} size="2xl" style={{ color: "#ffffff", }} />
                </a>
                <a
                  href="https://github.com/curious-vv1"
                  className="text-sm font-semibold leading-6 text-white"
                >
